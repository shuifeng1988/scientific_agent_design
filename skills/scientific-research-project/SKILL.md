...
5. Before execution, verify data version/hash, software/checkpoint/version, server/environment, command, resources, split, endpoint, QC, and failure policy. Heavy work belongs on the declared H100/V100 host.
